...
const students = [
  {
    id: "abc123",
    name: "Max",
    rewards: { elixir: 10, gold: 50, level: 2 },
    weeklyStats: {
      completedHabits: 5,
      completedTasks: 3,
      learningMethodsUsed: 2,
      totalPoints: 165,
    },
  },
  // ...weitere Schüler
...
const sendChatMessage = (message: { id: string; userId: string; userName: string; type: string; content: string; timestamp: string }) => {
  setChatMessages((prev) => [...prev, message])
}


const currentWeek = "2025-KW27"

// Removed duplicate default export Page. The main export is PasApasApp below.
...
export default function PasApasApp() {
  ...
  if (!currentUser) {
    alert("Kein Benutzer angemeldet. Bitte erneut anmelden.");
    return;
  }
                          ...
                          <div key={habit.id} className="border rounded-lg p-3">
                            <div className="flex items-center justify-between mb-2">
                              <div className="flex items-center space-x-2">
                                ...
                                />
                                <span className={`font-medium ${habit.completedToday ? "line-through text-gray-500" : ""}`}>
                                  {habit.name.length > 20 ? habit.name.substring(0, 20) + "..." : habit.name}
                                </span>
                              </div>
                              <div className="flex items-center space-x-2">
            ...
            <TabsContent value="leaderboard" className="space-y-6">
              <Leaderboard
                students={students.map((student) => ({
                  ...
                  weeklyStats: student.weeklyStats,
                }))}
